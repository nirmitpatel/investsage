...
type ActivePage = 'portfolio' | 'tax' | 'execution-plan' | 'insights' | 'analytics' | 'value' | 'smart-money'
...
const NAV_ITEMS: { key: ActivePage; label: string; href: string; icon: React.ReactNode }[] = [
  ...
  { key: 'smart-money', label: 'Smart Money', href: '/smart-money', icon: <SmartMoneyIcon /> },
]
