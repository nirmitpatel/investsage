    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white flex">
      ...
      <aside className="w-60 shrink-0 border-r border-white/[0.06] flex flex-col py-6 px-4">
        ...
        <nav className="flex-1 space-y-1">
          ...
          <NavItem icon={<LeafIcon />} label="Tax Savings" soon />
          <NavItem icon={<ShieldIcon />} label="Health Score" soon />
...
function NavItem({ icon, label, active, soon }: { icon: React.ReactNode; label: string; active?: boolean; soon?: boolean }) {
  return (
    <div className={`flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-sm transition cursor-pointer
      ${active
